...
"[project]/src/pages/api/users/doctors.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        try {
            const doctors = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
                where: {
                    role: "DOCTOR"
                },
                select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00363af6._.js.map