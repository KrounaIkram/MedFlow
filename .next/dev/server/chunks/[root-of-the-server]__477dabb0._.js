...
"[project]/MedFlow3/src/server/validators/patient.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const patientCreateSchema = __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].object({
    firstName: __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].string().min(1, "Prénom requis"),
...
"[project]/MedFlow3/src/pages/api/patients/index.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$validators$2f$patient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/MedFlow3/src/server/validators/patient.ts [api] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$validators$2f$patient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$validators$2f$patient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function handler(req, res) {
    if (req.method === "GET") {
        ...
        if (!session) return;
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].patient.findMany();
    ...
    if (req.method === "POST") {
        ...
        if (!session) return;
        const parse = __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$validators$2f$patient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["patientCreateSchema"].safeParse(req.body);
        if (!parse.success) return res.status(400).json({
            error: parse.error.format()
        });
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].patient.create({
            data: parse.data
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__477dabb0._.js.map