...
"[project]/src/pages/api/users/index.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (!session) return;
    if (req.method === "GET") {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
            select: {
                id: true,
                name: true,
                email: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__62431971._.js.map