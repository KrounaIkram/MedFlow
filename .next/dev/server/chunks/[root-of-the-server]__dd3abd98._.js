...
"[project]/MedFlow3/src/server/appointments/checkAvailability.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function isDoctorAvailable(doctorId, startDate, durationInMinutes) {
    ...
    const appointments = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].appointment.findMany({
        where: {
            doctorId,
            status: "SCHEDULED"
        }
...
"[project]/MedFlow3/src/pages/api/appointments/index.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$appointments$2f$checkAvailability$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/MedFlow3/src/server/appointments/checkAvailability.ts [api] (ecmascript)");
...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        ...
        const available = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$server$2f$appointments$2f$checkAvailability$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["isDoctorAvailable"])(doctorName, date, duration);
        ...
        const doctor = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].user.findFirst({
            where: {
                role: "DOCTOR",
                name: {
                    contains: doctorName,
        ...
        const patient = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].patient.findFirst({
            where: {
                firstName: {
                    contains: firstName,
                    mode: "insensitive"
        ...
        const appointment = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].appointment.create({
            data: {
                date,
                duration,
                type,
    ...
    // GET - Liste les RDV selon le rôle
    if (req.method === "GET") {
        if (session.user.role === "PATIENT") {
            ...
            if (!patient) {
                return res.status(200).json([]); // Aucun patient = aucune donnée
            }
            const appts = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].appointment.findMany({
                where: {
                    patientId: patient.id
                },
                include: {
        ...
        const where = {};
        // 🔑 Filtrage critique : seul ses propres RDV
        if (session.user.role === "DOCTOR") {
            where.doctorId = session.user.id;
        }
        // Si ADMIN ou RECEPTIONIST → where reste vide → tous les RDV
        const appts = await __TURBOPACK__imported__module__$5b$project$5d2f$MedFlow3$2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].appointment.findMany({
            where,
            include: {
                doctor: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd3abd98._.js.map